        ...
        private void Login()
        {
            try
            {
                ...
                if (SQLConn.dr.Read() == true)
                {
                    ...
                    {
                        frmMain m = new frmMain(SQLConn.dr["Username"].ToString(), Convert.ToInt32(SQLConn.dr["StaffID"]), SQLConn.dr["Role"].ToString());
                        m.Show();
                        this.Hide();
                    }
                    else 
                    {
                        frmPOS m = new frmPOS(SQLConn.dr["Username"].ToString(), Convert.ToInt32(SQLConn.dr["StaffID"]), SQLConn.dr["Role"].ToString());
