...
/*UPDATE  product SET  WholesalePrice = UnitPrice Where WholesalePrice = 0*/


alter table product add column UnitCost double NOT NULL default 1 after WholesalePrice ;
--
